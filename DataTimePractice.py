...
url = f"https://api.open-meteo.com/v1/forecast?latitude=51.76&longitude=14.33&start_date={start_date}&end_date={end_date}&daily=temperature_2m_max,temperature_2m_min"
...
plt.title('Cottbus Weather - Past Week')
plt.legend()
...
df.to_csv('data/cottbus_weather.csv', index=False)
